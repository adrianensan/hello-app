...
public extension HelloTheme {
  ...
  static func superBlack(accent: HelloColor) -> HelloTheme {
    HelloTheme(id: "super-black",
               ...
               headerLayer: .init(background: .blur(dark: true, overlay: .black.opacity(0.6))),
               floatingLayer: .init(background: .color(color: HelloColor(r: 0, g: 0, b: 0),
                                                       border: .init(color: .white.opacity(0.1)))),
               surfaceLayer: .init(background: .color(color: HelloColor(r: 0, g: 0, b: 0),
                                                      border: .init(color: .white.opacity(0.1)))))
  }
