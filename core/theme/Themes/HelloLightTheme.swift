public extension HelloTheme {
  ...
  static func helloLight(accent: HelloFill) -> HelloTheme {
    ...
    HelloTheme(id: "hello-light",
               name: "Hello Light",
               scheme: .light,
               baseLayer: .init(background: .color(color: HelloColor(r: 0.97, g: 0.97, b: 0.95),
                                                   border: .init(color: .black.opacity(0.1))),
                                accent: accent,
                                error: .color(color: .retroApple.red)),
               headerLayer: .init(background: .blur(dark: false, overlay: .white.opacity(0.4))),
               floatingLayer: .init(background: .color(color: HelloColor(r: 1, g: 1, b: 0.99),
                                                       border: .init(color: .black.opacity(0.1)))),
               surfaceLayer: .init(background: .color(color: HelloColor(r: 1, g: 1, b: 0.99),
                                                      border: .init(color: .black.opacity(0.1)))),
